...
extern "C"
{
    ...
    void _pay(const char* gameObject,const char* callbackMethod,int amount,const char* itemName,int count,const char* chargePointName,const char* customParams,const char* callbackUrl)
    {
        ...
        [[AgentManager instance] payWithAmount:amount itemName:cStr2NStr(itemName) count:count customParams:cStr2NStr(customParams) CallbackUrl:cStr2NStr(callbackUrl) Delegate:payCallback];
    }
