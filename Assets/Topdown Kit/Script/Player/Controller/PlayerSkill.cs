...
public class PlayerSkill : MonoBehaviour {
	...
	void CheckAddAttributePassive(int indexSkill)
	{
		...
		{	
			playerStatus.status.hp += Mathf.FloorToInt(passiveSkill[indexSkill].addValue);	
		}
		
		//Add MP
		if(passiveSkill[indexSkill].addAttribute == AddAttribute.mp)
		{
			playerStatus.status.mp += Mathf.FloorToInt(passiveSkill[indexSkill].addValue);	
		}
		
		//Add Attack
		if(passiveSkill[indexSkill].addAttribute == AddAttribute.atk)
		{
			playerStatus.status.atk += Mathf.FloorToInt(passiveSkill[indexSkill].addValue);	
		}
		
		//Add Defend
		if(passiveSkill[indexSkill].addAttribute == AddAttribute.def)
		{
			playerStatus.status.def += Mathf.FloorToInt(passiveSkill[indexSkill].addValue);	
		}
		
		//Add Speed
		if(passiveSkill[indexSkill].addAttribute == AddAttribute.spd)
		{
			playerStatus.status.spd += Mathf.FloorToInt(passiveSkill[indexSkill].addValue);	
		}
		
		//Add Hit
		if(passiveSkill[indexSkill].addAttribute == AddAttribute.hit)
		{
			playerStatus.status.hit += Mathf.FloorToInt(passiveSkill[indexSkill].addValue);	
		}
		
		//Add CriticalRate
		if(passiveSkill[indexSkill].addAttribute == AddAttribute.criticalRate)
		{
			playerStatus.status.criticalRate += passiveSkill[indexSkill].addValue;	
		}
		
		//Add Attack Speed
		if(passiveSkill[indexSkill].addAttribute == AddAttribute.atkSpd)
		{
			playerStatus.status.atkSpd += passiveSkill[indexSkill].addValue;	
		}
		
		//Add Attack Range
		if(passiveSkill[indexSkill].addAttribute == AddAttribute.atkRange)
		{
			playerStatus.status.atkRange += passiveSkill[indexSkill].addValue;	
		}
		
		//Add Move Speed
		if(passiveSkill[indexSkill].addAttribute == AddAttribute.moveSpd)
		{
			playerStatus.status.movespd += passiveSkill[indexSkill].addValue;	
		}
	...
	void CheckAddAttributeBuff(int indexSkill,string command)
	{
		...
		{	
			if(command == "Buff")
			playerStatus.status.hp += Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);	
			if(command == "Debuff")
			playerStatus.status.hp -= Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);	
		}
		...
		{
			if(command == "Buff")
			playerStatus.status.mp += Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);
			if(command == "Debuff")
			playerStatus.status.mp -= Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);	
		}
		...
		{
			if(command == "Buff")
			playerStatus.status.atk += Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);	
			if(command == "Debuff")
			playerStatus.status.atk -= Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);	
		}
		...
		{
			if(command == "Buff")
			playerStatus.status.def += Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);
			if(command == "Debuff")
			playerStatus.status.def -= Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);
		}
		...
		{
			if(command == "Buff")
			playerStatus.status.spd += Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);	
			if(command == "Debuff")
			playerStatus.status.spd -= Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);	
		}
		...
		{
			if(command == "Buff")
			playerStatus.status.hit += Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);	
			if(command == "Debuff")
			playerStatus.status.hit -= Mathf.FloorToInt(activeSkillBuff[indexSkill].addValue);
		}
		...
		{
			if(command == "Buff")
			playerStatus.status.criticalRate += activeSkillBuff[indexSkill].addValue;	
			if(command == "Debuff")
			playerStatus.status.criticalRate -= activeSkillBuff[indexSkill].addValue;	
		}
		...
		{
			if(command == "Buff")
			playerStatus.status.atkSpd += activeSkillBuff[indexSkill].addValue;	
			if(command == "Debuff")
			playerStatus.status.atkSpd -= activeSkillBuff[indexSkill].addValue;	
		}
		...
		{
			if(command == "Buff")
			playerStatus.status.atkRange += activeSkillBuff[indexSkill].addValue;	
			if(command == "Debuff")
			playerStatus.status.atkRange -= activeSkillBuff[indexSkill].addValue;	
		}
		...
		{
			if(command == "Buff")
			playerStatus.status.movespd += activeSkillBuff[indexSkill].addValue;	
			if(command == "Debuff")
			playerStatus.status.movespd -= activeSkillBuff[indexSkill].addValue;	
		}
	...
	public void ActiveSkill(string skillType,int indexSkill)
	{
		...
		}else if(skillType == "Attack")
		{
			if(activeSkillAttack[indexSkill].skillType == SkillType.Instance)
			{
				...
				skillArea.ReciveParameter(playerStatus.status.atk,activeSkillAttack[indexSkill].multipleDamage,activeSkillAttack[indexSkill].skillAccurate,activeSkillAttack[indexSkill].flichValue
			...
			}else if(activeSkillAttack[indexSkill].skillType == SkillType.LockTarget)
			{
				...
				}else  if(activeSkillAttack[indexSkill].targetSkill == TargetSkill.SingleTarget)
				{
					if(controller.target != null)
					{
						...
						enemy.GetDamage((playerStatus.status.atk) * activeSkillAttack[indexSkill].multipleDamage ,activeSkillAttack[indexSkill].skillAccurate,activeSkillAttack[indexSkill].flichValue
							,activeSkillAttack[indexSkill].skillFxTarget,activeSkillAttack[indexSkill].soundFxTarget);
					}
